// VENDORING PATCH (2026-07-18): upstream imports the bare specifier 'three'
// (resolved via npm/bundler at the original project's build time). This repo
// has no bundler and no import map, so the import line below is rewritten to
// a relative path pointing at our own vendored lib/vendor/three.module.js —
// the only hand-edit made to this file. See lib/vendor/VERSIONS.md.
import {
	BufferAttribute,
	BufferGeometry,
	Matrix4,
