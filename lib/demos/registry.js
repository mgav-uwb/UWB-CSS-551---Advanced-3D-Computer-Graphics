...
import { make as makeDiffusion2d } from './diffusion-2d.js';
import { make as makeDiffusionDigits } from './diffusion-digits.js';
import { make as makeDiffusionImage } from './diffusion-image.js';
import { make as makeDiffusionNet } from './diffusion-net.js';
import { make as makeMlpFit } from './mlp-fit.js';
import { make as makeEmbedMap } from './embed-map.js';
...
export const DEMOS = {
  ...
  'diffusion-2d': {
    title: 'Diffusion Models: Noise a Shape, Then Learn to Undo It',
    make: makeDiffusion2d,
  },
  'mlp-fit': {
    title: 'A Neural Network Is a Function: Train One to Fit a Curve, Live',
    make: makeMlpFit,
  },
  'embed-map': {
    title: 'Embeddings: The Trained Denoiser\'s Class Vectors, Mapped',
    make: makeEmbedMap,
  },
  'diffusion-image': {
    title: 'Diffusion Models: The Forward Process on a Real Image',
    make: makeDiffusionImage,
  },
  'diffusion-digits': {
    title: 'Diffusion Models: Real Digits, Conditioning, Guidance, and the Memorization Knob',
    make: makeDiffusionDigits,
  },
  'diffusion-net': {
    title: 'Diffusion Models: A Trained Denoiser, Live in the Browser',
    make: makeDiffusionNet,
  },
  'simplify-compare': {
