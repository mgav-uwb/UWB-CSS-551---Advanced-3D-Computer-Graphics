...
// pixels.
const PARAMS = {
  // offU max is 0.95, NOT 1.0: under RepeatWrapping a translation of exactly
  // 1.0 in U is the identity (one full texture period), so a harness drag
  // from 0 to 1 would render an identical image and fail the pixel probe.
  offU: { label: 'offU', min: -1, max: 0.95, step: 0.05, value: 0, format: (v) => v.toFixed(2) },
