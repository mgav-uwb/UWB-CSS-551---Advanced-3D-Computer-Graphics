...
export function make(container, { stage = 'embed', controls } = {}) {
  ...
  helpPanel.innerHTML = `
    ...
    <p>Underlying scene: "bonsai", one of the real-world scenes in the
    Mip-NeRF 360 dataset — Barron et al., "Mip-NeRF 360: Unbounded
    Anti-Aliased Neural Radiance Fields", CVPR 2022, Google Research.
    Gaussian-splat reconstruction + <code>.splat</code> packaging: dylanebert,
    published at huggingface.co/datasets/dylanebert/3dgs. This bonsai scene
    is also the de-facto standard smoke-test scene for the vendored
    mkkellogg/GaussianSplats3D viewer (MIT license) rendering it here — the
    same scene the library's own author uses in its official demo. Used for
    coursework/teaching (CSS 551, non-commercial, attributed); full chain of
    title in <code>media/gsplat/ATTRIBUTION.md</code>.</p>
